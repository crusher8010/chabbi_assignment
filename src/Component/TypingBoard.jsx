...
const TypingBoard = () => {
    ...
    const displayResults = () => {
        ...
        const cpm = charactersTyped;

        wpmTagRef.current.innerText = wpm;
        cpmTagRef.current.innerText = cpm;
    };
    ...
    const initTyping = () => {
        ...
        if (characterIndex < characters.length - 1 && timeLeft > 0) {
            ...
            cpmTagRef.current.innerText = characterIndex - errors;
    ...
    return (
        <div>
            ...
            <div className="details-container">
                ...
                <div className="cpm">
                    <label htmlFor="">CPM : </label>
                    <span ref={cpmTagRef}>{characterIndex - errors}</span>
                </div>
            </div>

            <div className="para">
                <p className="text-of-typing" ref={typingTextRef}>
                    { }
                </p>
            </div>
